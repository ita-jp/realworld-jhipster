...
export const UserExtendedDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="realworldjdlApp.userExtended.delete.question">
        <Translate contentKey="realworldjdlApp.userExtended.delete.question" interpolate={{ id: userExtendedEntity.id }}>
          Are you sure you want to delete this UserExtended?
        </Translate>
      </ModalBody>
      <ModalFooter>
