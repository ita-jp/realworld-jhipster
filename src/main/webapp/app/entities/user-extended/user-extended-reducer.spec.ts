...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREXTENDED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USEREXTENDED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USEREXTENDED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USEREXTENDED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USEREXTENDED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USEREXTENDED actions', async () => {
      const arg = 42666;
